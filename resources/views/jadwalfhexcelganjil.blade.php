    ...
    <div class="container">
        <table class='table table-bordered'>
            <thead>
                ...
                <tr >
                    <th ></th>
                    <th colspan="3" style="text-align: center; font-family: arial; font-size: 10px;">SEMESTER  I</th>
                    <th colspan="3" style="text-align: center; font-family: arial; font-size: 10px;">SEMESTER  III</th>
                    <th colspan="3" style="text-align: center; font-family: arial; font-size: 10px;">SEMESTER  V</th>
                    <th colspan="3" style="text-align: center; font-family: arial; font-size: 10px;">SEMESTER  VII</th>
                </tr>                             
                <tr style="text-align: center; font-family: arial; font-size: 10px;">
            ...
            @if(($s->hari == "Senin") and ($s->jam == "08:00:00") and ($s->semester != "SEMESTER II") and ($s->semester != "SEMESTER IV")  and ($s->semester != "SEMESTER VI") and ($s->semester != "SEMESTER VIII"))
                <tr style="text-align: center; font-family: arial; font-size: 10px;">
                    <td>08.00-10.30</td>
                    @if(($s->semester == "SEMESTER I") and ($s->prodi == "IESP"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>
                    @else
                    <td></td>
                    @endif
                    @if(($s->semester == "SEMESTER I") and ($s->prodi == "MANAJEMEN"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>  
                    @else
                    <td></td>
                    @endif      
                    @if(($s->semester == "SEMESTER I") and ($s->prodi == "AKUNTANSI"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>  
                    @else
                    <td></td>
                    @endif  
                    @if(($s->semester == "SEMESTER III") and ($s->prodi == "IESP"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>
                    @else
                    <td></td>
                    @endif
                    @if(($s->semester == "SEMESTER III") and ($s->prodi == "MANAJEMEN"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>  
                    @else
                    <td></td>
                    @endif      
                    @if(($s->semester == "SEMESTER III") and ($s->prodi == "AKUNTANSI"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>  
                    @else
                    <td></td>
                    @endif 
                    @if(($s->semester == "SEMESTER V") and ($s->prodi == "IESP"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>
                    @else
                    <td></td>
                    @endif
                    @if(($s->semester == "SEMESTER V") and ($s->prodi == "MANAJEMEN"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>  
                    @else
                    <td></td>
                    @endif      
                    @if(($s->semester == "SEMESTER V") and ($s->prodi == "AKUNTANSI"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>  
                    @else
                    <td></td>
                    @endif 
                    @if(($s->semester == "SEMESTER VII") and ($s->prodi == "IESP"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>
                    @else
                    <td></td>
                    @endif
                    @if(($s->semester == "SEMESTER VII") and ($s->prodi == "MANAJEMEN"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>  
                    @else
                    <td></td>
                    @endif      
                    @if(($s->semester == "SEMESTER VII") and ($s->prodi == "AKUNTANSI"))
                    <td>{{$s->nama_matkul}} ({{$s->kelas}}) ({{$s->ruangan}})</td>  
                    @else
                    <td></td>
                    @endif 
